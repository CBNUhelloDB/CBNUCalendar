...
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('2', '1');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('3', '1');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('4', '2');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('1', '2');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('2', '2');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('3', '3');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('6', '3');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('7', '4');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('4', '4');
INSERT INTO `events_calendar`.`participants` (`user_id`, `event_id`) VALUES ('5', '4');
